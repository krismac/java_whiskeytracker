...
public class DistilleryController {
        ...
        public List<Distillery> getAllDistilleriesWithWhiskiesOfGivenAge(@PathVariable int age) {
            return distilleryRepository.findAllDistilleriesWithWhiskiesOfGivenAge(age);
